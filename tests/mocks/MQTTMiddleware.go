...
func (_m *MQTTMiddleware) Init(authenticationCertificatePath string) error {
...
func (_m *MQTTMiddleware) Subscribe(topic string, qos byte, callback mqtt.MessageHandler) error {
